...
class GeminiService {
  ...
  Future<String> generateRecipe(String ingredients, {String? category}) async {
    try {
      final categoryPrompt =
          category != null ? 'Create a $category recipe' : 'Create a recipe';

      final prompt = '''$categoryPrompt using these ingredients: $ingredients.
